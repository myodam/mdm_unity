...
namespace Mediapipe.Unity.Sample.PoseLandmarkDetection
{
  public class PoseLandmarkerRunner : VisionTaskApiRunner<PoseLandmarker>
  {
    ...
    public event Action<PoseLandmarkerResult> OnPoseLandmarksDetected;
    ...
    private void NotifyPoseLandmarksDetected(PoseLandmarkerResult result)
    {
      OnPoseLandmarksDetected?.Invoke(result);
    }
